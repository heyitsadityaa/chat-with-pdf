          ...
          {(isGlobalLoading) => (
            <>
              <SignIn.Step name="start">
                <Card className="w-full sm:w-96 border-sky-500 shadow-2xl shadow-sky-500/70 border-2">
                  <CardHeader>
                    <CardTitle>
                      Sign in to{" "}
                      <span className="text-sky-500">Chat with PDF</span>
                    </CardTitle>
                    <CardDescription>
                  ...
                  <CardContent className="grid gap-y-4">
                    ...
                    <Clerk.Field name="identifier" className="space-y-2">
                      ...
                      <Clerk.Input type="email" required asChild>
                        <Input className="outline-sky-500" />
                      </Clerk.Input>
                  ...
                  <CardFooter>
                    <div className="grid w-full gap-y-4">
                      <SignIn.Action submit asChild>
                        <Button
                          disabled={isGlobalLoading}
                          className="bg-sky-500 text-white hover:bg-sky-500/80"
                        >
                          <Clerk.Loading>
                            {(isLoading) => {
                              return isLoading ? (
