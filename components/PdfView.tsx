...
// gsutil cors set cors.json gs://chat-with-pdf-e9da4.appspot.com
// go here >>> https://console.cloud.google.com/
// create new file in editor calls corsi json
// run >>> // gsutil cors set cors.json gs://chat-with-pdf-e9da4.appspot.com
